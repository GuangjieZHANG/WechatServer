...
public class HttpRequest {
	...
	// requests for monitor to provide services
		...
		// create a get request (need the url of resource) -- retrieve 
		public String getidReq(String code) throws IOException{
			URL u = new URL("https://api.weixin.qq.com/sns/jscode2session?"
					+ "appid=wxdb60380d6979d8ad"
					+ "&secret=77f3be0fdcbbbaaf665cdb7f5717c679"
					+ "&js_code="+code
